...
<h3 class = "catItemTitle">
		<?php echo $this->escape(htmlspecialchars_decode($this->mapparams->get('page_title'))); ?>
</h3>
</div>
<?php endif; ?>
<div id="dynamapcontainer2">

<?php if ($this->mapparams->get('pageclass_sfx') == "map"): ?>
	<div id="dyna-left">
...
<?php if($this->mapparams->get('pageclass_sfx') == "list"): ?>
<div id="dyna-right">
